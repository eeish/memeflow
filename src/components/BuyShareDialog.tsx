...
import { ShoppingCart, Loader2, TrendingUp, AlertTriangle, Info } from './ui-simple/Icons';
...
export const BuyShareDialog: React.FC<BuyShareDialogProps> = ({
  ...
  // Prevent the backdrop from closing the dialog while a purchase is in progress.
  const handleOpenChange = (newOpen: boolean) => {
    if (!newOpen && isPurchasing) return;
