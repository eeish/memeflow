#!/usr/bin/env python3
"""
MemeFlow Database Reset Utility

This script provides comprehensive database management for MemeFlow development.
...
class DatabaseManager:
    """Manages MemeFlow database operations"""
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.potential_db_paths = [
            self.service_dir / "db" / "memeflow.db",        # ./db/memeflow.db (old config)
            self.service_dir / "db" / "test.db",            # ./db/test.db (found existing)
            self.service_dir / "memeflow.db",               # ./memeflow.db (current config)
            self.script_dir.parent / "db" / "memeflow.db",  # ../db/memeflow.db
            self.script_dir.parent / "memeflow.db",         # ../memeflow.db
        ]
    ...
    def find_database_file(self) -> Optional[Path]:
        ...
        return self.service_dir / "memeflow.db"
    ...
    def check_database_state(self):
        ...
        self.log("🔍 MemeFlow Database Status Check", Colors.WHITE)
    ...
    def generate_sql_reset_script(self) -> str:
        ...
        return """-- MemeFlow SQLite Database Reset Script
-- This script safely truncates all tables while preserving schema
-- Generated by MemeFlow Database Manager
...
"""
    ...
    def start_service(self) -> bool:
        ...
        self.log_info("Starting MemeFlow service...")
        ...
        try:
            ...
            process = subprocess.Popen(
                ["cargo", "run", "--bin", "memeflow-service"],
    ...
    def full_reset(self, restart_service: bool = True, force: bool = False) -> bool:
        ...
        self.log("🔄 MemeFlow Database Reset", Colors.WHITE)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MemeFlow Database Reset Utility",
